...
HOW TO DEPLOY (MASHA'S INSTRUCTIONS)
1. Install aws CLI. Then, Do the following command:
```sh
aws configure
```
...
Here is the info:
```sh
AWS Access Key ID [None]: AKIASAIMA74ZF7EUNZ2Q
AWS Secret Access Key [None]: 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
Default region name [None]: us-east-2
Default output format [None]: json
```

2. Install the eksctl cli. Then, do the following:
```sh
eksctl create cluster --name microservices-demo-cluster --region us-east-2
```
...
6. Once you are done with it, delete the GKE cluster.
   ...
   ```sh
   eksctl delete cluster --name microservices-demo-cluster --region us-east-2
   ```
